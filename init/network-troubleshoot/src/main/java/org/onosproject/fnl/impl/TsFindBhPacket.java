...
/**
 * Virtual packet for Blackhole Tracing.
 */
public final class TsFindBhPacket implements Serializable {
    ...
    /**
     * Create an initial virtual packet inside for Blackhole Tracing.
     */
    protected TsFindBhPacket() {
        match = new HashMap<>();
        pathFlow = new Stack<>();
        pathDevice = new Stack<>();
        pathLink = new Stack<>();
    ...
    public SetHeaderValue setHeader(Criterion criterion) {
        ...
        return hasKey ? SetHeaderValue.SET_HEADER_OVERRIDE : SetHeaderValue.SET_HEADER_VALUE;
    }
    ...
    /**
     * Create a new object and copy the data from itself.
     *
    ...
    public void matchBuilder(Iterable<Criterion> criterions) {
        ...
        for (Criterion criterion : criterions) {
            ...
            if (SetHeaderValue.SET_HEADER_VALUE == ret) {
    ...
    /**
     * Representation of the result of setting header.
     */
    enum SetHeaderValue {
        /**
